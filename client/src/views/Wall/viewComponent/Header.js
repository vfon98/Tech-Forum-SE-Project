      ...
      <>
        ...
        <div className={classes.wrap}>
          <Grid container className={classes.container}>
            ...
            <Grid item xs={12} sm={8} className={classes.contentWrapper}>
              <div>
                <p className={classes.displayName}>
                  {data ? data.displayName : 'Loading...'}
                </p>
                <p className={classes.job}>{data ? data.job : null}</p>
          ...
          {this.props.permission == 'edit' ? (
            <Button className={classes.editBtn} onClick={this.handlePopup}>
              <Edit />
            </Button>
          ) : null}
        </div>
